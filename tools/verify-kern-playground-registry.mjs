...
invariant(
  apiCoverage.publicInputsAndModels === 892,
  `Expected 892 public inputs/models, received ${apiCoverage.publicInputsAndModels}.`,
);
invariant(
  apiCoverage.controlled === 591,
  `Expected 591 directly controlled public inputs/models, received ${apiCoverage.controlled}.`,
);
invariant(
  apiCoverage.excluded === 301,
  `Expected 301 exact API exclusions, received ${apiCoverage.excluded}.`,
);
