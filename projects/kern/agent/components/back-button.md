...
| -------- | ------- | ------------------- | ------------------------------- | ------------------------ | --------------------------------------- |
| `label`  | text    | `"Back to catalog"` | `"Back to catalog · alternate"` | input `label` (property) | Changes the back-button label.          |
| `href`   | text    | `"/"`               | `"#specimen-overview"`          | input `href` (property)  | Configures the component href contract. |
