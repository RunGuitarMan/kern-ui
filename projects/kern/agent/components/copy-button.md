...
| `copyLabel`        | input  | `string \| undefined` | no       | `undefined`                     | Localized visible fallback used only when no action label is projected.                                                                                                            |
| `copyingLabel`     | input  | `string \| undefined` | no       | `undefined`                     | Loading announcement while the asynchronous write is in flight.                                                                                                                    |
| `copiedLabel`      | input  | `string \| undefined` | no       | `undefined`                     | Success announcement paired with the visible success indicator.                                                                                                                    |
| `errorLabel`       | input  | `string \| undefined` | no       | `undefined`                     | Failure announcement paired with the visible error indicator.                                                                                                                      |
