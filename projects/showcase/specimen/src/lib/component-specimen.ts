...
export const KERN_SPECIMEN_CURATED_RENDERER_CONTROLS = Object.freeze({
  ...
  'toggle-group': rendererControls('orientation', 'size', 'connected', 'multiple', 'disabled'),
  ...
  'native-select': rendererControls(
    'placeholder',
    'size',
    'disabled',
    'readOnly',
  ...
  alert: rendererControls('tone', 'appearance', 'title', 'dismissible'),
  banner: rendererControls('tone', 'appearance', 'title', 'dismissible'),
  ...
  drawer: rendererControls('open', 'side', 'size', 'modal'),
  'bottom-sheet': rendererControls('open', 'size', 'modal'),
  ...
  badge: rendererControls('tone', 'variant', 'size', 'status'),
  'status-badge': rendererControls('tone', 'variant', 'size', 'status'),
  ...
  'json-view': rendererControls('defaultExpandDepth', 'highlightPattern', 'sortKeys', 'wrap'),
...
export class KernComponentSpecimen {
  ...
  protected readonly jsonPayload = {
    deployment: {
      id: 'dep_01KERN',
      active: true,
      replicas: 3,
