...
| `closeLabel`      | accessibility-copy | `a11y-test:tests/a11y/accessibility.spec.ts#drawer`          | This localizable action label is stable accessibility copy; interaction/state controls exercise the same component behavior without duplicating every locale string. |
...
| `restoreFocus`    | complex-data       | `specimen-fixture:preview/drawer?state=default`              | The public type is not a lossless scalar/literal contract and requires a typed specimen fixture.                                                                     |
