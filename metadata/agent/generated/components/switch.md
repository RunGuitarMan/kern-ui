...
- ID: `switch`
- Selector: `krn-switch`
- Import: `import { KrnSwitch } from '@kern-ui/angular/kit';`
- Canonical symbol: `KrnSwitch`
- Lifecycle: **stable**
- Category: Forms

Switch. A typed form control with visible state, reliable labeling, and Angular Forms semantics.
...
Angular Forms control with value type `boolean`.
...
| ------------- | ------- | ------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------ | ------------------------------------------------- |
| `selected`    | boolean | `false`                                                       | `true`                                                                    | fixture interaction            | Turns the setting on.                             |
