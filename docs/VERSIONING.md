...
- the `@kern-ui/angular` compatibility entry point; the `/cdk`, `/core`, `/kit`, `/addon-grid`,
  `/addon-charts`, `/patterns`, and `/testing` entry points; declared style subpaths; and their
